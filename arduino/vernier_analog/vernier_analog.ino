...
/*
Updated by Donald Merand for Explo (2015.06)
To make this work, you'll want to use Explo's fork of the Sparkfun Vernier Library:
https://github.com/exploration/SparkFun_Vernier_Interface_Shield_Arduino_Library
*/
